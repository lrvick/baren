...
Baren.libs["databarexpanded"]=function() {
	...
	function $f8(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("expandedstacked");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	function $f17(){
		this.stk[this.ptr++]=Baren.psstring("0100");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f18(){
		...
		if (t===undefined) throw new Error("dict: aival: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("01");
		...
		if (t===undefined) throw new Error("dict: aival: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("3103");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	function $f20(){
		this.stk[this.ptr++]=Baren.psstring("0101");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f21(){
		...
		if (t===undefined) throw new Error("dict: aival: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("3202");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	function $f24(){
		...
		if (t===undefined) throw new Error("dict: aival: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("3203");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	function $f29(){
		...
		this.stk[this.ptr++]=true;
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring("11"),Baren.psstring("13"),Baren.psstring("15"),Baren.psstring("17")]);
		this.stk[this.ptr++]=$f28;
		var t39=this.stk[--this.ptr];
		var t38=this.stk[--this.ptr];
		for (t37 in t38) {
			if (t38 instanceof Baren.psstring || t38 instanceof Baren.psarray) {
	...
	function $f31(){
		this.stk[this.ptr++]=Baren.psstring("0111000");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f32(){
		this.stk[this.ptr++]=Baren.psstring("0111001");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f33(){
		this.stk[this.ptr++]=Baren.psstring("0111010");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f34(){
		this.stk[this.ptr++]=Baren.psstring("0111011");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f35(){
		this.stk[this.ptr++]=Baren.psstring("0111100");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f36(){
		this.stk[this.ptr++]=Baren.psstring("0111101");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f37(){
		this.stk[this.ptr++]=Baren.psstring("0111110");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f38(){
		this.stk[this.ptr++]=Baren.psstring("0111111");
		this.stk[this.ptr++]=false;
		return -1;
	}
	function $f39(){
	...
	function $f48(){
		this.stk[this.ptr++]=Baren.psstring("01100");
		this.stk[this.ptr++]=true;
		return -1;
	}
	function $f49(){
	...
	function $f52(){
		this.stk[this.ptr++]=Baren.psstring("01101");
		this.stk[this.ptr++]=true;
		return -1;
	}
	function $f53(){
	...
	function $f56(){
		...
		this.stk[this.ptr++]=Baren.psstring("00");
		this.stk[this.ptr++]=true;
		return -1;
	}
	function $f57(){
		this.stk[this.ptr++]=Baren.psstring("0000000000000000000000000000000000000000");
	...
	function $f58(){
		this.stk[this.ptr++]=Baren.psstring("00000000000000000000000000000000000000000000");
	...
	function $f65(){
		...
		for (t86 in t87) {
			if (t87 instanceof Baren.psstring || t87 instanceof Baren.psarray) {
	...
	function $f69(){
		...
		for (t92 in t93) {
			if (t93 instanceof Baren.psstring || t93 instanceof Baren.psarray) {
	...
	function $f73(){
		...
		for (t98 in t99) {
			if (t99 instanceof Baren.psstring || t99 instanceof Baren.psarray) {
	...
	function $f76(){
		...
		for (t102 in t103) {
			if (t103 instanceof Baren.psstring || t103 instanceof Baren.psarray) {
		...
		for (t105 in t106) {
			if (t106 instanceof Baren.psstring || t106 instanceof Baren.psarray) {
	...
	function $f79(){
		...
		for (t112 in t113) {
			if (t113 instanceof Baren.psstring || t113 instanceof Baren.psarray) {
	...
	function $f101(){
		...
		for (t186 in t187) {
			if (t187 instanceof Baren.psstring || t187 instanceof Baren.psarray) {
		...
		for (t189 in t190) {
			if (t190 instanceof Baren.psstring || t190 instanceof Baren.psarray) {
	...
	function $f109(){
		...
		for (t203 in t204) {
			if (t204 instanceof Baren.psstring || t204 instanceof Baren.psarray) {
	...
	function $f134(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]="mode"; //ident
		this.stk[this.ptr++]=Baren.psstring("iso646");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	}
	function $f135(){
	...
	function $f149(){
		...
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psarray([0,0,1,0,0]);
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("pad");
		if (t===undefined) throw new Error("dict: pad: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f172(){
		...
		for (t297 in t298) {
			if (t298 instanceof Baren.psstring || t298 instanceof Baren.psarray) {
	...
	function $f182(){
		...
		for (t327 in t328) {
			if (t328 instanceof Baren.psstring || t328 instanceof Baren.psarray) {
	...
	function $f185(){
		...
		for (t338 in t339) {
			if (t339 instanceof Baren.psstring || t339 instanceof Baren.psarray) {
	...
	function $f192(){
		...
		for (t349 in t350) {
			if (t350 instanceof Baren.psstring || t350 instanceof Baren.psarray) {
	...
	function $f197(){
		...
		for (t370 in t371) {
			if (t371 instanceof Baren.psstring || t371 instanceof Baren.psarray) {
	...
	function $f198(){
		...
		for (t367 in t368) {
			if (t368 instanceof Baren.psstring || t368 instanceof Baren.psarray) {
	...
	function $f222(){
		...
		for (t398 in t399) {
			if (t399 instanceof Baren.psstring || t399 instanceof Baren.psarray) {
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=Baren.psarray([0,0,0,0]);
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		var t=this.dstk.get("sep");
		if (t===undefined) throw new Error("dict: sep: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		for (t422 in t423) {
			if (t423 instanceof Baren.psstring || t423 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]=Baren.psstring("expanded");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="segments"; //ident
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	for (t123 in t124) {
		if (t124 instanceof Baren.psstring || t124 instanceof Baren.psarray) {
	...
	for (t136 in t137) {
		if (t137 instanceof Baren.psstring || t137 instanceof Baren.psarray) {
	...
	if (t===undefined) throw new Error("dict: fnc1: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("01111");
	this.stk[this.ptr++]=65;
	this.stk[this.ptr++]=1;
	...
	this.stk[this.ptr++]=42;
	this.stk[this.ptr++]=Baren.psstring("111010");
	this.stk[this.ptr++]=44;
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=47;
	...
	if (t===undefined) throw new Error("dict: liso646: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("00100");
	var t = {};
	for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
		t[this.stk[i-1]]=this.stk[i];
	...
	this.stk[this.ptr++]=33;
	this.stk[this.ptr++]=Baren.psstring("11101000");
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=Baren.psstring("11101001");
	...
	this.stk[this.ptr++]=Baren.psstring("11111011");
	this.stk[this.ptr++]=32;
	this.stk[this.ptr++]=Baren.psstring("11111100");
	var t=this.dstk.get("lnumeric");
	if (t===undefined) throw new Error("dict: lnumeric: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("000");
	...
	this.stk[this.ptr++]=Baren.psarray([347,0,12,5,7,2,87,4,1387,348,10,7,5,4,52,20,2947,1388,8,9,4,5,30,52,3987,2948,6,11,3,6,10,104,4191,3988,4,13,1,8,1,204]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	this.stk[this.ptr++]=Baren.psarray([1,8,4,1,1,1,1,4,8,1,3,6,4,1,1,1,1,4,6,3,3,4,6,1,1,1,1,6,4,3,3,2,8,1,1,1,1,8,2,3,2,6,5,1,1,1,1,5,6,2,2,2,9,1,1,1,1,9,2,2]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="finderseq"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([0,1]);
	this.stk[this.ptr++]=Baren.psarray([0,3,2]);
	this.stk[this.ptr++]=Baren.psarray([0,5,2,7]);
	this.stk[this.ptr++]=Baren.psarray([0,9,2,7,4]);
	this.stk[this.ptr++]=Baren.psarray([0,9,2,7,6,11]);
	this.stk[this.ptr++]=Baren.psarray([0,9,2,7,8,11,10]);
	this.stk[this.ptr++]=Baren.psarray([0,1,2,3,4,5,6,7]);
	this.stk[this.ptr++]=Baren.psarray([0,1,2,3,4,5,6,9,8]);
	this.stk[this.ptr++]=Baren.psarray([0,1,2,3,4,5,6,9,10,11]);
	this.stk[this.ptr++]=Baren.psarray([0,1,2,3,4,7,6,9,8,11,10]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	for (t324 in t325) {
		if (t325 instanceof Baren.psstring || t325 instanceof Baren.psarray) {
	...
	for (t330 in t331) {
		if (t331 instanceof Baren.psstring || t331 instanceof Baren.psarray) {
