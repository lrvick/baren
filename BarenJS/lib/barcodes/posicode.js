...
Baren.libs["posicode"]=function() {
	...
	function $f30(){
		...
		this.stk[this.ptr++]=Baren.psstring("set1");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f31(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]="cset"; //ident
		this.stk[this.ptr++]=Baren.psstring("set0");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f32(){
		var t=this.dstk.get("cset");
	...
	function $f52(){
		...
		for (t68 in t69) {
			if (t69 instanceof Baren.psstring || t69 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]="normal"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("0"),Baren.psstring("^"),Baren.psstring("'")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("1"),Baren.psstring(";"),27]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("2"),Baren.psstring("<"),28]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("3"),Baren.psstring("="),29]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("4"),Baren.psstring(">"),30]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("5"),Baren.psstring("?"),31]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("6"),Baren.psstring("@"),Baren.psstring("!")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("7"),Baren.psstring("["),Baren.psstring("\"")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("8"),92,Baren.psstring("#")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("9"),Baren.psstring("]"),Baren.psstring("&")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("A"),Baren.psstring("a"),1]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("B"),Baren.psstring("b"),2]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("C"),Baren.psstring("c"),3]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("D"),Baren.psstring("d"),4]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("E"),Baren.psstring("e"),5]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("F"),Baren.psstring("f"),6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("G"),Baren.psstring("g"),7]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("H"),Baren.psstring("h"),8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("I"),Baren.psstring("i"),9]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("J"),Baren.psstring("j"),10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("K"),Baren.psstring("k"),11]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("L"),Baren.psstring("l"),12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("M"),Baren.psstring("m"),13]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("N"),Baren.psstring("n"),14]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("O"),Baren.psstring("o"),15]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("P"),Baren.psstring("p"),16]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Q"),Baren.psstring("q"),17]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("R"),Baren.psstring("r"),18]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("S"),Baren.psstring("s"),19]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("T"),Baren.psstring("t"),20]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("U"),Baren.psstring("u"),21]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("V"),Baren.psstring("v"),22]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("W"),Baren.psstring("w"),23]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("X"),Baren.psstring("x"),24]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Y"),Baren.psstring("y"),25]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Z"),Baren.psstring("z"),26]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("-"),Baren.psstring("_"),40]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("."),Baren.psstring("`"),41]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring(" "),127,0]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("$"),Baren.psstring("{"),Baren.psstring("*")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("/"),Baren.psstring("|"),Baren.psstring(",")]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("+"),Baren.psstring("}"),Baren.psstring(":")]);
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("%");
	...
	this.stk[this.ptr++]="limited"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("0"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("1"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("2"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("3"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("4"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("5"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("6"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("7"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("8"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("9"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("A"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("B"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("C"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("D"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("E"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("F"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("G"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("H"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("I"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("J"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("K"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("L"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("M"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("N"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("O"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("P"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Q"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("R"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("S"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("T"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("U"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("V"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("W"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("X"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Y"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("Z"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("-"),-98,-98]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("."),-98,-98]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("141112"),Baren.psstring("131212"),Baren.psstring("121312"),Baren.psstring("111412"),Baren.psstring("131113"),Baren.psstring("121213"),Baren.psstring("111313"),Baren.psstring("121114"),Baren.psstring("111214"),Baren.psstring("111115"),Baren.psstring("181111"),Baren.psstring("171211"),Baren.psstring("161311"),Baren.psstring("151411"),Baren.psstring("141511"),Baren.psstring("131611"),Baren.psstring("121711"),Baren.psstring("111811"),Baren.psstring("171112"),Baren.psstring("161212"),Baren.psstring("151312"),Baren.psstring("141412"),Baren.psstring("131512"),Baren.psstring("121612"),Baren.psstring("111712"),Baren.psstring("161113"),Baren.psstring("151213"),Baren.psstring("141313"),Baren.psstring("131413"),Baren.psstring("121513"),Baren.psstring("111613"),Baren.psstring("151114"),Baren.psstring("141214"),Baren.psstring("131314"),Baren.psstring("121414"),Baren.psstring("111514"),Baren.psstring("141115"),Baren.psstring("131215"),Baren.psstring("121315"),Baren.psstring("111415"),Baren.psstring("131116"),Baren.psstring("121216"),Baren.psstring("111316"),Baren.psstring("121117"),Baren.psstring("111217"),Baren.psstring("111118"),Baren.psstring("1<111112"),Baren.psstring("111111111;1")]);
	this.stk[this.ptr++]="b"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("151213"),Baren.psstring("141313"),Baren.psstring("131413"),Baren.psstring("121513"),Baren.psstring("141214"),Baren.psstring("131314"),Baren.psstring("121414"),Baren.psstring("131215"),Baren.psstring("121315"),Baren.psstring("121216"),Baren.psstring("191212"),Baren.psstring("181312"),Baren.psstring("171412"),Baren.psstring("161512"),Baren.psstring("151612"),Baren.psstring("141712"),Baren.psstring("131812"),Baren.psstring("121912"),Baren.psstring("181213"),Baren.psstring("171313"),Baren.psstring("161413"),Baren.psstring("151513"),Baren.psstring("141613"),Baren.psstring("131713"),Baren.psstring("121813"),Baren.psstring("171214"),Baren.psstring("161314"),Baren.psstring("151414"),Baren.psstring("141514"),Baren.psstring("131614"),Baren.psstring("121714"),Baren.psstring("161215"),Baren.psstring("151315"),Baren.psstring("141415"),Baren.psstring("131515"),Baren.psstring("121615"),Baren.psstring("151216"),Baren.psstring("141316"),Baren.psstring("131416"),Baren.psstring("121516"),Baren.psstring("141217"),Baren.psstring("131317"),Baren.psstring("121417"),Baren.psstring("131218"),Baren.psstring("121318"),Baren.psstring("121219"),Baren.psstring("1<121312"),Baren.psstring("121212121<1")]);
	this.stk[this.ptr++]="limiteda"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("111411"),Baren.psstring("111312"),Baren.psstring("111213"),Baren.psstring("111114"),Baren.psstring("121311"),Baren.psstring("121212"),Baren.psstring("121113"),Baren.psstring("141111"),Baren.psstring("131211"),Baren.psstring("131112"),Baren.psstring("171111"),Baren.psstring("161211"),Baren.psstring("151311"),Baren.psstring("141411"),Baren.psstring("131511"),Baren.psstring("121611"),Baren.psstring("111711"),Baren.psstring("161112"),Baren.psstring("151212"),Baren.psstring("141312"),Baren.psstring("131412"),Baren.psstring("121512"),Baren.psstring("111612"),Baren.psstring("151113"),Baren.psstring("141213"),Baren.psstring("131313"),Baren.psstring("121413"),Baren.psstring("111513"),Baren.psstring("141114"),Baren.psstring("131214"),Baren.psstring("121314"),Baren.psstring("111414"),Baren.psstring("131115"),Baren.psstring("121215"),Baren.psstring("111315"),Baren.psstring("121116"),Baren.psstring("111216"),Baren.psstring("111117"),Baren.psstring("151111"),Baren.psstring("1")]);
	this.stk[this.ptr++]="limitedb"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("121512"),Baren.psstring("121413"),Baren.psstring("121314"),Baren.psstring("121215"),Baren.psstring("131412"),Baren.psstring("131313"),Baren.psstring("131214"),Baren.psstring("151212"),Baren.psstring("141312"),Baren.psstring("141213"),Baren.psstring("181212"),Baren.psstring("171312"),Baren.psstring("161412"),Baren.psstring("151512"),Baren.psstring("141612"),Baren.psstring("131712"),Baren.psstring("121812"),Baren.psstring("171213"),Baren.psstring("161313"),Baren.psstring("151413"),Baren.psstring("141513"),Baren.psstring("131613"),Baren.psstring("121713"),Baren.psstring("161214"),Baren.psstring("151314"),Baren.psstring("141414"),Baren.psstring("131514"),Baren.psstring("121614"),Baren.psstring("151215"),Baren.psstring("141315"),Baren.psstring("131415"),Baren.psstring("121515"),Baren.psstring("141216"),Baren.psstring("131316"),Baren.psstring("121416"),Baren.psstring("131217"),Baren.psstring("121317"),Baren.psstring("121218"),Baren.psstring("141212"),Baren.psstring("1")]);
	var t = {};
	for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
		t[this.stk[i-1]]=this.stk[i];
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([495,330,210,126,70,35,15,5]);
	this.stk[this.ptr++]=Baren.psarray([165,120,84,56,35,20,10,4]);
	this.stk[this.ptr++]=Baren.psarray([45,36,28,21,15,10,6,3]);
	this.stk[this.ptr++]=Baren.psarray([9,8,7,6,5,4,3,2]);
	this.stk[this.ptr++]=Baren.psarray([1,1,1,1,1,1,1,1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	for (t52 in t53) {
		if (t53 instanceof Baren.psstring || t53 instanceof Baren.psarray) {
	...
	if (t===undefined) throw new Error("dict: version: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("limiteda");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
	...
	if (t===undefined) throw new Error("dict: version: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("limitedb");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
	...
	this.stk[this.ptr++]="d"; //ident
	this.stk[this.ptr++]=Baren.psarray([2,2,2,2,2,2]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="r"; //ident
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	this.stk[this.ptr++]=Baren.psstring("111111111111");
	...
	for (t82 in t83) {
		if (t83 instanceof Baren.psstring || t83 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]=Baren.psstring("center");
