...
//if (!Baren.libs["databarexpandedstacked"]) Baren.load("bwipp/databarexpandedstacked.js");
//if (!Baren.libs["gs1-cc"]) Baren.load("bwipp/gs1-cc.js");
//if (!Baren.libs["renmatrix"]) Baren.load("bwipp/renmatrix.js");
Baren.libs["databarexpandedstackedcomposite"]=function() {
	this.dict["databarexpandedstacked"]=Baren.libs["databarexpandedstacked"];
	...
	this.stk[this.ptr++]=Baren.psstring("databarexpandedstacked");
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
		this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
	else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	this.ptr-=3;
