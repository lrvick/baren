...
Baren.libs["flattermarken"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("0018"),Baren.psstring("0117"),Baren.psstring("0216"),Baren.psstring("0315"),Baren.psstring("0414"),Baren.psstring("0513"),Baren.psstring("0612"),Baren.psstring("0711"),Baren.psstring("0810"),Baren.psstring("0900")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("1234567890");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
