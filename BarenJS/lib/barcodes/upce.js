...
//if (!Baren.libs["ean2"]) Baren.load("bwipp/ean2.js");
//if (!Baren.libs["ean5"]) Baren.load("bwipp/ean5.js");
Baren.libs["upce"]=function() {
	this.dict["renlinear"]=Baren.libs["renlinear"];
	this.dict["ean2"]=Baren.libs["ean2"];
	this.dict["ean5"]=Baren.libs["ean5"];
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	function $f45(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("sbs");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: addcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("bhs");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
		...
		for (t71 in t72) {
			if (t72 instanceof Baren.psstring || t72 instanceof Baren.psarray) {
		...
		if (t===undefined) throw new Error("dict: addcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("bbs");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("3211"),Baren.psstring("2221"),Baren.psstring("2122"),Baren.psstring("1411"),Baren.psstring("1132"),Baren.psstring("1231"),Baren.psstring("1114"),Baren.psstring("1312"),Baren.psstring("1213"),Baren.psstring("3112"),Baren.psstring("111"),Baren.psstring("111111")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("0123456789");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="mirrormaps"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("000111"),Baren.psstring("001011"),Baren.psstring("001101"),Baren.psstring("001110"),Baren.psstring("010011"),Baren.psstring("011001"),Baren.psstring("011100"),Baren.psstring("010101"),Baren.psstring("010110"),Baren.psstring("011010")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	for (t45 in t46) {
		if (t46 instanceof Baren.psstring || t46 instanceof Baren.psarray) {
