...
Baren.libs["code2of5"]=function() {
	...
	this.stk[this.ptr++]=Baren.psstring("industrial");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("1111313111"),Baren.psstring("3111111131"),Baren.psstring("1131111131"),Baren.psstring("3131111111"),Baren.psstring("1111311131"),Baren.psstring("3111311111"),Baren.psstring("1131311111"),Baren.psstring("1111113131"),Baren.psstring("3111113111"),Baren.psstring("1131113111"),Baren.psstring("313111"),Baren.psstring("31113")]);
	this.stk[this.ptr++]="iata"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("1111313111"),Baren.psstring("3111111131"),Baren.psstring("1131111131"),Baren.psstring("3131111111"),Baren.psstring("1111311131"),Baren.psstring("3111311111"),Baren.psstring("1131311111"),Baren.psstring("1111113131"),Baren.psstring("3111113111"),Baren.psstring("1131113111"),Baren.psstring("1111"),Baren.psstring("311")]);
	this.stk[this.ptr++]="matrix"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("113311"),Baren.psstring("311131"),Baren.psstring("131131"),Baren.psstring("331111"),Baren.psstring("113131"),Baren.psstring("313111"),Baren.psstring("133111"),Baren.psstring("111331"),Baren.psstring("311311"),Baren.psstring("131311"),Baren.psstring("311111"),Baren.psstring("31111")]);
	this.stk[this.ptr++]="coop"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("331111"),Baren.psstring("111331"),Baren.psstring("113131"),Baren.psstring("113311"),Baren.psstring("131131"),Baren.psstring("131311"),Baren.psstring("133111"),Baren.psstring("311131"),Baren.psstring("311311"),Baren.psstring("313111"),Baren.psstring("3131"),Baren.psstring("133")]);
	this.stk[this.ptr++]="datalogic"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("113311"),Baren.psstring("311131"),Baren.psstring("131131"),Baren.psstring("331111"),Baren.psstring("113131"),Baren.psstring("313111"),Baren.psstring("133111"),Baren.psstring("111331"),Baren.psstring("311311"),Baren.psstring("131311"),Baren.psstring("1111"),Baren.psstring("311")]);
	var t = {};
	...
	for (t8 in t9) {
		if (t9 instanceof Baren.psstring || t9 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]=Baren.psstring("0123456789");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	for (t27 in t28) {
		if (t28 instanceof Baren.psstring || t28 instanceof Baren.psarray) {
