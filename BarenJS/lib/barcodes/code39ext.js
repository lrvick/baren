...
Baren.libs["code39ext"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("%U"),Baren.psstring("$A"),Baren.psstring("$B"),Baren.psstring("$C"),Baren.psstring("$D"),Baren.psstring("$E"),Baren.psstring("$F"),Baren.psstring("$G"),Baren.psstring("$H"),Baren.psstring("$I"),Baren.psstring("$J"),Baren.psstring("$K"),Baren.psstring("$L"),Baren.psstring("$M"),Baren.psstring("$N"),Baren.psstring("$O"),Baren.psstring("$P"),Baren.psstring("$Q"),Baren.psstring("$R"),Baren.psstring("$S"),Baren.psstring("$T"),Baren.psstring("$U"),Baren.psstring("$V"),Baren.psstring("$W"),Baren.psstring("$X"),Baren.psstring("$Y"),Baren.psstring("$Z"),Baren.psstring("%A"),Baren.psstring("%B"),Baren.psstring("%C"),Baren.psstring("%D"),Baren.psstring("%E"),Baren.psstring(" "),Baren.psstring("/A"),Baren.psstring("/B"),Baren.psstring("/C"),Baren.psstring("/D"),Baren.psstring("/E"),Baren.psstring("/F"),Baren.psstring("/G"),Baren.psstring("/H"),Baren.psstring("/I"),Baren.psstring("/J"),Baren.psstring("/K"),Baren.psstring("/L"),Baren.psstring("-"),Baren.psstring("."),Baren.psstring("/O"),Baren.psstring("0"),Baren.psstring("1"),Baren.psstring("2"),Baren.psstring("3"),Baren.psstring("4"),Baren.psstring("5"),Baren.psstring("6"),Baren.psstring("7"),Baren.psstring("8"),Baren.psstring("9"),Baren.psstring("/Z"),Baren.psstring("%F"),Baren.psstring("%G"),Baren.psstring("%H"),Baren.psstring("%I"),Baren.psstring("%J"),Baren.psstring("%V"),Baren.psstring("A"),Baren.psstring("B"),Baren.psstring("C"),Baren.psstring("D"),Baren.psstring("E"),Baren.psstring("F"),Baren.psstring("G"),Baren.psstring("H"),Baren.psstring("I"),Baren.psstring("J"),Baren.psstring("K"),Baren.psstring("L"),Baren.psstring("M"),Baren.psstring("N"),Baren.psstring("O"),Baren.psstring("P"),Baren.psstring("Q"),Baren.psstring("R"),Baren.psstring("S"),Baren.psstring("T"),Baren.psstring("U"),Baren.psstring("V"),Baren.psstring("W"),Baren.psstring("X"),Baren.psstring("Y"),Baren.psstring("Z"),Baren.psstring("%K"),Baren.psstring("%L"),Baren.psstring("%M"),Baren.psstring("%N"),Baren.psstring("%O"),Baren.psstring("%W"),Baren.psstring("+A"),Baren.psstring("+B"),Baren.psstring("+C"),Baren.psstring("+D"),Baren.psstring("+E"),Baren.psstring("+F"),Baren.psstring("+G"),Baren.psstring("+H"),Baren.psstring("+I"),Baren.psstring("+J"),Baren.psstring("+K"),Baren.psstring("+L"),Baren.psstring("+M"),Baren.psstring("+N"),Baren.psstring("+O"),Baren.psstring("+P"),Baren.psstring("+Q"),Baren.psstring("+R"),Baren.psstring("+S"),Baren.psstring("+T"),Baren.psstring("+U"),Baren.psstring("+V"),Baren.psstring("+W"),Baren.psstring("+X"),Baren.psstring("+Y"),Baren.psstring("+Z"),Baren.psstring("%P"),Baren.psstring("%Q"),Baren.psstring("%R"),Baren.psstring("%S"),Baren.psstring("%T")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
