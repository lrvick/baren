...
Baren.libs["auspost"]=function() {
	...
	function $f26(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=64;
		this.stk[this.ptr++]=Baren.psarray([48,17,29,30,1]);
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
	...
	this.stk[this.ptr++]=Baren.psstring("character");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("000"),Baren.psstring("001"),Baren.psstring("002"),Baren.psstring("010"),Baren.psstring("011"),Baren.psstring("012"),Baren.psstring("020"),Baren.psstring("021"),Baren.psstring("022"),Baren.psstring("100"),Baren.psstring("101"),Baren.psstring("102"),Baren.psstring("110"),Baren.psstring("111"),Baren.psstring("112"),Baren.psstring("120"),Baren.psstring("121"),Baren.psstring("122"),Baren.psstring("200"),Baren.psstring("201"),Baren.psstring("202"),Baren.psstring("210"),Baren.psstring("211"),Baren.psstring("212"),Baren.psstring("220"),Baren.psstring("221"),Baren.psstring("222"),Baren.psstring("300"),Baren.psstring("301"),Baren.psstring("302"),Baren.psstring("310"),Baren.psstring("311"),Baren.psstring("312"),Baren.psstring("320"),Baren.psstring("321"),Baren.psstring("322"),Baren.psstring("023"),Baren.psstring("030"),Baren.psstring("031"),Baren.psstring("032"),Baren.psstring("033"),Baren.psstring("103"),Baren.psstring("113"),Baren.psstring("123"),Baren.psstring("130"),Baren.psstring("131"),Baren.psstring("132"),Baren.psstring("133"),Baren.psstring("203"),Baren.psstring("213"),Baren.psstring("223"),Baren.psstring("230"),Baren.psstring("231"),Baren.psstring("232"),Baren.psstring("233"),Baren.psstring("303"),Baren.psstring("313"),Baren.psstring("323"),Baren.psstring("330"),Baren.psstring("331"),Baren.psstring("332"),Baren.psstring("333"),Baren.psstring("003"),Baren.psstring("013"),Baren.psstring("00"),Baren.psstring("01"),Baren.psstring("02"),Baren.psstring("10"),Baren.psstring("11"),Baren.psstring("12"),Baren.psstring("20"),Baren.psstring("21"),Baren.psstring("22"),Baren.psstring("30"),Baren.psstring("13"),Baren.psstring("3")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz #");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.stk[this.ptr++]=Baren.psstring("45");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
	...
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.stk[this.ptr++]=Baren.psstring("59");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
	...
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.stk[this.ptr++]=Baren.psstring("62");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
