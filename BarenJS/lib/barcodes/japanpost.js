...
Baren.libs["japanpost"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("300"),Baren.psstring("330"),Baren.psstring("312"),Baren.psstring("132"),Baren.psstring("321"),Baren.psstring("303"),Baren.psstring("123"),Baren.psstring("231"),Baren.psstring("213"),Baren.psstring("033"),Baren.psstring("030"),Baren.psstring("120"),Baren.psstring("102"),Baren.psstring("210"),Baren.psstring("012"),Baren.psstring("201"),Baren.psstring("021"),Baren.psstring("003"),Baren.psstring("333"),Baren.psstring("31"),Baren.psstring("13")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("0123456789-ABCDEFGHIJKLMNOPQRSTUVWXYZ");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
