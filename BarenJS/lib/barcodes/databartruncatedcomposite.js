...
//if (!Baren.libs["databartruncated"]) Baren.load("bwipp/databartruncated.js");
...
Baren.libs["databartruncatedcomposite"]=function() {
	this.dict["databartruncated"]=Baren.libs["databartruncated"];
	...
	this.stk[this.ptr++]=Baren.psstring("databartruncated");
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
		this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
	else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	this.ptr-=3;
	...
	for (t32 in t33) {
		if (t33 instanceof Baren.psstring || t33 instanceof Baren.psarray) {
