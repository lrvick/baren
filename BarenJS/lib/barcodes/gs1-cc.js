...
//if (!Baren.libs["pdf417"]) Baren.load("bwipp/pdf417.js");
//if (!Baren.libs["micropdf417"]) Baren.load("bwipp/micropdf417.js");
Baren.libs["gs1-cc"]=function() {
	this.dict["renmatrix"]=Baren.libs["renmatrix"];
	this.dict["pdf417"]=Baren.libs["pdf417"];
	this.dict["micropdf417"]=Baren.libs["micropdf417"];
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	function $f30(){
		...
		if (t===undefined) throw new Error("dict: aival: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("90");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	function $f51(){
		...
		for (t93 in t94) {
			if (t94 instanceof Baren.psstring || t94 instanceof Baren.psarray) {
	...
	function $f52(){
		this.stk[this.ptr++]="cdf"; //ident
		this.stk[this.ptr++]=Baren.psarray([1,0,1,1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f53(){
	}
	...
	function $f55(){
		...
		for (t100 in t101) {
			if (t101 instanceof Baren.psstring || t101 instanceof Baren.psarray) {
	...
	function $f84(){
		...
		for (t135 in t136) {
			if (t136 instanceof Baren.psstring || t136 instanceof Baren.psarray) {
		...
		for (t138 in t139) {
			if (t139 instanceof Baren.psstring || t139 instanceof Baren.psarray) {
	...
	function $f87(){
		...
		for (t141 in t142) {
			if (t142 instanceof Baren.psstring || t142 instanceof Baren.psarray) {
		...
		for (t144 in t145) {
			if (t145 instanceof Baren.psstring || t145 instanceof Baren.psarray) {
	...
	function $f96(){
		...
		for (t159 in t160) {
			if (t160 instanceof Baren.psstring || t160 instanceof Baren.psarray) {
	...
	function $f101(){
		...
		for (t170 in t171) {
			if (t171 instanceof Baren.psstring || t171 instanceof Baren.psarray) {
	...
	function $f102(){
		...
		if (t===undefined) throw new Error("dict: ais1: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("8004");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	function $f103(){
		this.stk[this.ptr++]="cdf"; //ident
		this.stk[this.ptr++]=Baren.psarray([1,1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		...
		for (t116 in t117) {
			if (t117 instanceof Baren.psstring || t117 instanceof Baren.psarray) {
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]=Baren.psstring("BDHIJKLNPQRSTVXZ");
		var t=this.dstk.get("ai90");
		if (t===undefined) throw new Error("dict: ai90: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("npre");
	...
	function $f113(){
		...
		for (t199 in t200) {
			if (t200 instanceof Baren.psstring || t200 instanceof Baren.psarray) {
		...
		for (t202 in t203) {
			if (t203 instanceof Baren.psstring || t203 instanceof Baren.psarray) {
	...
	function $f117(){
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([167,138,118,108,88,78,59]);
		this.stk[this.ptr++]=Baren.psarray([167,138,118,98,78]);
		this.stk[this.ptr++]=Baren.psarray([197,167,138,108,78]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([336,296,256,208,160,104,56]);
		this.stk[this.ptr++]=Baren.psarray([768,648,536,416,304,208,152,112,72,32]);
		this.stk[this.ptr++]=Baren.psarray([1184,1016,840,672,496,352,264,208,152,96,56]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		for (t212 in t213) {
			if (t213 instanceof Baren.psstring || t213 instanceof Baren.psarray) {
	...
	function $f129(){
		...
		if (t===undefined) throw new Error("dict: lintype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("gs1-128");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	function $f135(){
		...
		for (t232 in t233) {
			if (t233 instanceof Baren.psstring || t233 instanceof Baren.psarray) {
	...
	function $f186(){
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([0,0,0,0,0,0,1]);
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("dontdraw");
		this.stk[this.ptr++]=true;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
			this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
		else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("cca");
		this.stk[this.ptr++]=true;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
			this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
		else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("columns");
		var t=this.dstk.get("cccolumns");
		if (t===undefined) throw new Error("dict: cccolumns: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
	...
	function $f188(){
		...
		for (t328 in t329) {
			if (t329 instanceof Baren.psstring || t329 instanceof Baren.psarray) {
	...
	function $f189(){
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("ccb");
		this.stk[this.ptr++]=true;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
			this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
		else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	...
	function $f191(){
		...
		for (t337 in t338) {
			if (t338 instanceof Baren.psstring || t338 instanceof Baren.psarray) {
	...
	function $f192(){
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("ccc");
		this.stk[this.ptr++]=true;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
			this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
		else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	...
	for (t196 in t197) {
		if (t197 instanceof Baren.psstring || t197 instanceof Baren.psarray) {
