...
//if (!Baren.libs["code128"]) Baren.load("bwipp/code128.js");
Baren.libs["gs1-128"]=function() {
	this.dict["renlinear"]=Baren.libs["renlinear"];
	this.dict["code128"]=Baren.libs["code128"];
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	function $f22(){
		...
		for (t36 in t37) {
			if (t37 instanceof Baren.psstring || t37 instanceof Baren.psarray) {
		...
		for (t39 in t40) {
			if (t40 instanceof Baren.psstring || t40 instanceof Baren.psarray) {
	...
	function $f27(){
		this.stk[this.ptr++]=Baren.psstring("^LNKA");
	}
	function $f28(){
		this.stk[this.ptr++]=Baren.psstring("^LNKC");
	}
	function $f29(){
		var t=this.dstk.get("barcode");
		if (t===undefined) throw new Error("dict: barcode: undefined");
	...
	for (t20 in t21) {
		if (t21 instanceof Baren.psstring || t21 instanceof Baren.psarray) {
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("height");
	var t=this.dstk.get("height");
	if (t===undefined) throw new Error("dict: height: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
	...
	if (t===undefined) throw new Error("dict: args: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("textxalign");
