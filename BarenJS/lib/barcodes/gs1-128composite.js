...
//if (!Baren.libs["gs1-128"]) Baren.load("bwipp/gs1-128.js");
//if (!Baren.libs["gs1-cc"]) Baren.load("bwipp/gs1-cc.js");
//if (!Baren.libs["renlinear"]) Baren.load("bwipp/renlinear.js");
//if (!Baren.libs["renmatrix"]) Baren.load("bwipp/renmatrix.js");
Baren.libs["gs1-128composite"]=function() {
	this.dict["gs1-128"]=Baren.libs["gs1-128"];
	this.dict["gs1-cc"]=Baren.libs["gs1-cc"];
	...
	function $f12(){
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("linkagea");
		this.stk[this.ptr++]=true;
		...
		if (t===undefined) throw new Error("dict: options: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("linkagec");
		this.stk[this.ptr++]=false;
		if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
			this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
		else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("inkspread");
	...
	for (t10 in t11) {
		if (t11 instanceof Baren.psstring || t11 instanceof Baren.psarray) {
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("lintype");
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("linwidth");
	var t=this.dstk.get("linwidth");
	if (t===undefined) throw new Error("dict: linwidth: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("pixx");
	if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
	else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
	this.ptr--;
