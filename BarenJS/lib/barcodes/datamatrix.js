...
Baren.libs["datamatrix"]=function() {
	...
	function $f127(){
		...
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=Baren.psarray([1,0]);
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		var t=this.dstk.get("mmat");
		if (t===undefined) throw new Error("dict: mmat: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([10,10,1,1,5,1]);
	this.stk[this.ptr++]=Baren.psarray([12,12,1,1,7,1]);
	this.stk[this.ptr++]=Baren.psarray([14,14,1,1,10,1]);
	this.stk[this.ptr++]=Baren.psarray([16,16,1,1,12,1]);
	this.stk[this.ptr++]=Baren.psarray([18,18,1,1,14,1]);
	this.stk[this.ptr++]=Baren.psarray([20,20,1,1,18,1]);
	this.stk[this.ptr++]=Baren.psarray([22,22,1,1,20,1]);
	this.stk[this.ptr++]=Baren.psarray([24,24,1,1,24,1]);
	this.stk[this.ptr++]=Baren.psarray([26,26,1,1,28,1]);
	this.stk[this.ptr++]=Baren.psarray([32,32,2,2,36,1]);
	this.stk[this.ptr++]=Baren.psarray([36,36,2,2,42,1]);
	this.stk[this.ptr++]=Baren.psarray([40,40,2,2,48,1]);
	this.stk[this.ptr++]=Baren.psarray([44,44,2,2,56,1]);
	this.stk[this.ptr++]=Baren.psarray([48,48,2,2,68,1]);
	this.stk[this.ptr++]=Baren.psarray([52,52,2,2,84,2]);
	this.stk[this.ptr++]=Baren.psarray([64,64,4,4,112,2]);
	this.stk[this.ptr++]=Baren.psarray([72,72,4,4,144,4]);
	this.stk[this.ptr++]=Baren.psarray([80,80,4,4,192,4]);
	this.stk[this.ptr++]=Baren.psarray([88,88,4,4,224,4]);
	this.stk[this.ptr++]=Baren.psarray([96,96,4,4,272,4]);
	this.stk[this.ptr++]=Baren.psarray([104,104,4,4,336,6]);
	this.stk[this.ptr++]=Baren.psarray([120,120,6,6,408,6]);
	this.stk[this.ptr++]=Baren.psarray([132,132,6,6,496,8]);
	this.stk[this.ptr++]=Baren.psarray([144,144,6,6,620,10]);
	this.stk[this.ptr++]=Baren.psarray([8,18,1,1,7,1]);
	this.stk[this.ptr++]=Baren.psarray([8,32,1,2,11,1]);
	this.stk[this.ptr++]=Baren.psarray([12,26,1,1,14,1]);
	this.stk[this.ptr++]=Baren.psarray([12,36,1,2,18,1]);
	this.stk[this.ptr++]=Baren.psarray([16,36,1,2,24,1]);
	this.stk[this.ptr++]=Baren.psarray([16,48,1,2,28,1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	for (t114 in t115) {
		if (t115 instanceof Baren.psstring || t115 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]=Baren.psarray([$f71,$f72,$f73,$f74,$f75,$f76,$f77,$f78]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="dmc1"; //ident
	this.stk[this.ptr++]=Baren.psarray([$f79,$f80,$f81,$f82,$f83,$f84,$f85,$f86]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="dmc2"; //ident
	this.stk[this.ptr++]=Baren.psarray([$f87,$f88,$f89,$f90,$f91,$f92,$f93,$f94]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="dmc3"; //ident
	this.stk[this.ptr++]=Baren.psarray([$f95,$f96,$f97,$f98,$f99,$f100,$f101,$f102]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="dmc4"; //ident
	this.stk[this.ptr++]=Baren.psarray([$f103,$f104,$f105,$f106,$f107,$f108,$f109,$f110]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
