...
Baren.libs["msi"]=function() {
	...
	function $f10(){
		...
		for (t13 in t14) {
			if (t14 instanceof Baren.psstring || t14 instanceof Baren.psarray) {
	...
	function $f28(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("mod10");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: checktype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("mod1010");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: checktype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("mod11");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: checktype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("ncrmod11");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: checktype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("mod1110");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: checktype: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("ncrmod1110");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("12121212"),Baren.psstring("12121221"),Baren.psstring("12122112"),Baren.psstring("12122121"),Baren.psstring("12211212"),Baren.psstring("12211221"),Baren.psstring("12212112"),Baren.psstring("12212121"),Baren.psstring("21121212"),Baren.psstring("21121221"),Baren.psstring("21"),Baren.psstring("121")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
