...
Baren.libs["micropdf417"]=function() {
	...
	function $f20(){
		...
		for (t17 in t18) {
			if (t18 instanceof Baren.psstring || t18 instanceof Baren.psarray) {
		...
		for (t23 in t24) {
			if (t24 instanceof Baren.psstring || t24 instanceof Baren.psarray) {
	...
	function $f22(){
		...
		for (t34 in t35) {
			if (t35 instanceof Baren.psstring || t35 instanceof Baren.psarray) {
	...
	function $f47(){
		...
		for (t99 in t100) {
			if (t100 instanceof Baren.psstring || t100 instanceof Baren.psarray) {
	...
	this.stk[this.ptr++]="metrics"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([1,11,7,1,0,9]);
	this.stk[this.ptr++]=Baren.psarray([1,14,7,8,0,8]);
	this.stk[this.ptr++]=Baren.psarray([1,17,7,36,0,36]);
	this.stk[this.ptr++]=Baren.psarray([1,20,8,19,0,19]);
	this.stk[this.ptr++]=Baren.psarray([1,24,8,9,0,17]);
	this.stk[this.ptr++]=Baren.psarray([1,28,8,25,0,33]);
	this.stk[this.ptr++]=Baren.psarray([2,8,8,1,0,1]);
	this.stk[this.ptr++]=Baren.psarray([2,11,9,1,0,9]);
	this.stk[this.ptr++]=Baren.psarray([2,14,9,8,0,8]);
	this.stk[this.ptr++]=Baren.psarray([2,17,10,36,0,36]);
	this.stk[this.ptr++]=Baren.psarray([2,20,11,19,0,19]);
	this.stk[this.ptr++]=Baren.psarray([2,23,13,9,0,17]);
	this.stk[this.ptr++]=Baren.psarray([2,26,15,27,0,35]);
	this.stk[this.ptr++]=Baren.psarray([3,6,12,1,1,1]);
	this.stk[this.ptr++]=Baren.psarray([3,8,14,7,7,7]);
	this.stk[this.ptr++]=Baren.psarray([3,10,16,15,15,15]);
	this.stk[this.ptr++]=Baren.psarray([3,12,18,25,25,25]);
	this.stk[this.ptr++]=Baren.psarray([3,15,21,37,37,37]);
	this.stk[this.ptr++]=Baren.psarray([3,20,26,1,17,33]);
	this.stk[this.ptr++]=Baren.psarray([3,26,32,1,9,17]);
	this.stk[this.ptr++]=Baren.psarray([3,32,38,21,29,37]);
	this.stk[this.ptr++]=Baren.psarray([3,38,44,15,31,47]);
	this.stk[this.ptr++]=Baren.psarray([3,44,50,1,25,49]);
	this.stk[this.ptr++]=Baren.psarray([4,4,8,47,19,43]);
	this.stk[this.ptr++]=Baren.psarray([4,6,12,1,1,1]);
	this.stk[this.ptr++]=Baren.psarray([4,8,14,7,7,7]);
	this.stk[this.ptr++]=Baren.psarray([4,10,16,15,15,15]);
	this.stk[this.ptr++]=Baren.psarray([4,12,18,25,25,25]);
	this.stk[this.ptr++]=Baren.psarray([4,15,21,37,37,37]);
	this.stk[this.ptr++]=Baren.psarray([4,20,26,1,17,33]);
	this.stk[this.ptr++]=Baren.psarray([4,26,32,1,9,17]);
	this.stk[this.ptr++]=Baren.psarray([4,32,38,21,29,37]);
	this.stk[this.ptr++]=Baren.psarray([4,38,44,15,31,47]);
	this.stk[this.ptr++]=Baren.psarray([4,44,50,1,25,49]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([2,5,4,39,0,19]);
	this.stk[this.ptr++]=Baren.psarray([2,6,4,1,0,33]);
	this.stk[this.ptr++]=Baren.psarray([2,7,5,32,0,12]);
	this.stk[this.ptr++]=Baren.psarray([2,8,5,8,0,40]);
	this.stk[this.ptr++]=Baren.psarray([2,9,6,14,0,46]);
	this.stk[this.ptr++]=Baren.psarray([2,10,6,43,0,23]);
	this.stk[this.ptr++]=Baren.psarray([2,12,7,20,0,52]);
	this.stk[this.ptr++]=Baren.psarray([3,4,4,11,43,23]);
	this.stk[this.ptr++]=Baren.psarray([3,5,5,1,33,13]);
	this.stk[this.ptr++]=Baren.psarray([3,6,6,5,37,17]);
	this.stk[this.ptr++]=Baren.psarray([3,7,7,15,47,27]);
	this.stk[this.ptr++]=Baren.psarray([3,8,7,21,1,33]);
	this.stk[this.ptr++]=Baren.psarray([4,3,4,40,20,52]);
	this.stk[this.ptr++]=Baren.psarray([4,4,5,43,23,3]);
	this.stk[this.ptr++]=Baren.psarray([4,5,6,46,26,6]);
	this.stk[this.ptr++]=Baren.psarray([4,6,7,34,14,46]);
	this.stk[this.ptr++]=Baren.psarray([4,7,8,29,9,41]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([802,930,946,818,882,890,826,954,922,986,970,906,778,794,786,914,978,982,980,916,948,932,934,942,940,936,808,812,814,806,822,950,918,790,788,820,884,868,870,878,876,872,840,856,860,862,846,844,836,838,834,866]);
	this.stk[this.ptr++]=Baren.psarray([718,590,622,558,550,566,534,530,538,570,562,546,610,626,634,762,754,758,630,628,612,614,582,578,706,738,742,740,748,620,556,552,616,744,712,716,708,710,646,654,652,668,664,696,688,656,720,592,600,604,732,734]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="rwid"; //ident
	this.stk[this.ptr++]=Baren.psarray([38,55,82,99]);
	var t=this.dstk.get("c");
	if (t===undefined) throw new Error("dict: c: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=1;
