...
Baren.libs["pdf417"]=function() {
	...
	function $f19(){
		...
		for (t16 in t17) {
			if (t17 instanceof Baren.psstring || t17 instanceof Baren.psarray) {
	...
	function $f21(){
		...
		for (t33 in t34) {
			if (t34 instanceof Baren.psstring || t34 instanceof Baren.psarray) {
	...
	function $f60(){
		...
		for (t115 in t116) {
			if (t116 instanceof Baren.psstring || t116 instanceof Baren.psarray) {
	...
	function $f63(){
		...
		for (t121 in t122) {
			if (t122 instanceof Baren.psstring || t122 instanceof Baren.psarray) {
	...
	function $f64(){
		...
		for (t118 in t119) {
			if (t119 instanceof Baren.psstring || t119 instanceof Baren.psarray) {
