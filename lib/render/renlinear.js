...
Baren.libs["renlinear"]=function() {
	...
	function $f12(){
		...
		for (t21 in t22) {
			if (t22 instanceof Baren.psstring || t22 instanceof Baren.psarray) {
	...
	function $f23(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-1]=this.findfont(Baren.psstring(this.stk[this.ptr-1]));
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f26(){
		...
		for (t40 in t41) {
			if (t41 instanceof Baren.psstring || t41 instanceof Baren.psarray) {
	...
	function $f28(){
		...
		for (t43 in t44) {
			if (t44 instanceof Baren.psstring || t44 instanceof Baren.psarray) {
	...
	function $f30(){
		...
		for (t46 in t47) {
			if (t47 instanceof Baren.psstring || t47 instanceof Baren.psarray) {
	...
	function $f35(){
		...
		this.ptr--;
		var m=(Baren.pstype(this.stk[this.ptr-1])=="arraytype"?this.stk[--this.ptr]:null);
	...
	function $f44(){
		...
		if (t===undefined) throw new Error("dict: textxalign: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("right");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: textxalign: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("offleft");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: textxalign: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("offright");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t===undefined) throw new Error("dict: textxalign: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("justify");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("above");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	this.stk[this.ptr++]=Baren.psstring("Courier");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	for (t0 in t1) {
		if (t1 instanceof Baren.psstring || t1 instanceof Baren.psarray) {
	...
	for (t3 in t4) {
		if (t4 instanceof Baren.psstring || t4 instanceof Baren.psarray) {
