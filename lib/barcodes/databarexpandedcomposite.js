...
//if (!Baren.libs["databarexpanded"]) Baren.load("bwipp/databarexpanded.js");
...
Baren.libs["databarexpandedcomposite"]=function() {
	this.dict["databarexpanded"]=Baren.libs["databarexpanded"];
	...
	this.stk[this.ptr++]=Baren.psstring("databarexpanded");
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
		this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
	else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	this.ptr-=3;
	...
	for (t26 in t27) {
		if (t27 instanceof Baren.psstring || t27 instanceof Baren.psarray) {
	...
	for (t29 in t30) {
		if (t30 instanceof Baren.psstring || t30 instanceof Baren.psarray) {
