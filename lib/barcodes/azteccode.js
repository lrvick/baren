...
Baren.libs["azteccode"]=function() {
	...
	function $f14(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=Baren.psstring("11111");
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		var t=this.dstk.get("msgbits");
		if (t===undefined) throw new Error("dict: msgbits: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f22(){
		...
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + Baren.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=Baren.psstring("000000000000");
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=-1;
		var b=this.stk[--this.ptr]; var a=this.stk[--this.ptr];
	...
	function $f45(){
		...
		for (t64 in t65) {
			if (t65 instanceof Baren.psstring || t65 instanceof Baren.psarray) {
	...
	function $f51(){
		...
		for (t84 in t85) {
			if (t85 instanceof Baren.psstring || t85 instanceof Baren.psarray) {
	...
	function $f81(){
		...
		for (t164 in t165) {
			if (t165 instanceof Baren.psstring || t165 instanceof Baren.psarray) {
	...
	function $f82(){
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([-5,7]);
		this.stk[this.ptr++]=Baren.psarray([-4,7]);
		this.stk[this.ptr++]=Baren.psarray([-3,7]);
		this.stk[this.ptr++]=Baren.psarray([-2,7]);
		this.stk[this.ptr++]=Baren.psarray([-1,7]);
		this.stk[this.ptr++]=Baren.psarray([1,7]);
		this.stk[this.ptr++]=Baren.psarray([2,7]);
		this.stk[this.ptr++]=Baren.psarray([3,7]);
		this.stk[this.ptr++]=Baren.psarray([4,7]);
		this.stk[this.ptr++]=Baren.psarray([5,7]);
		this.stk[this.ptr++]=Baren.psarray([7,5]);
		this.stk[this.ptr++]=Baren.psarray([7,4]);
		this.stk[this.ptr++]=Baren.psarray([7,3]);
		this.stk[this.ptr++]=Baren.psarray([7,2]);
		this.stk[this.ptr++]=Baren.psarray([7,1]);
		this.stk[this.ptr++]=Baren.psarray([7,-1]);
		this.stk[this.ptr++]=Baren.psarray([7,-2]);
		this.stk[this.ptr++]=Baren.psarray([7,-3]);
		this.stk[this.ptr++]=Baren.psarray([7,-4]);
	...
	function $f83(){
		this.stk[this.ptr++]="modemap"; //ident
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([-3,5]);
		this.stk[this.ptr++]=Baren.psarray([-2,5]);
		this.stk[this.ptr++]=Baren.psarray([-1,5]);
		this.stk[this.ptr++]=Baren.psarray([0,5]);
		this.stk[this.ptr++]=Baren.psarray([1,5]);
		this.stk[this.ptr++]=Baren.psarray([2,5]);
		this.stk[this.ptr++]=Baren.psarray([3,5]);
		this.stk[this.ptr++]=Baren.psarray([5,3]);
		this.stk[this.ptr++]=Baren.psarray([5,2]);
		this.stk[this.ptr++]=Baren.psarray([5,1]);
		this.stk[this.ptr++]=Baren.psarray([5,0]);
		this.stk[this.ptr++]=Baren.psarray([5,-1]);
		this.stk[this.ptr++]=Baren.psarray([5,-2]);
		this.stk[this.ptr++]=Baren.psarray([5,-3]);
		this.stk[this.ptr++]=Baren.psarray([3,-5]);
	...
	function $f85(){
		...
		for (t172 in t173) {
			if (t173 instanceof Baren.psstring || t173 instanceof Baren.psarray) {
	...
	if (t===undefined) throw new Error("dict: format: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("rune");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()!=this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]!=this.stk[this.ptr-1];
	this.ptr--;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("rune"),0,0,0,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("compact"),1,1,17,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),1,1,21,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("compact"),2,0,40,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),2,1,48,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("compact"),3,0,51,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),3,1,60,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("compact"),4,0,76,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),4,1,88,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),5,1,120,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),6,1,156,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),7,1,196,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),8,1,240,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),9,1,230,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),10,1,272,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),11,1,316,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),12,1,364,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),13,1,416,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),14,1,470,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),15,1,528,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),16,1,588,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),17,1,652,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),18,1,720,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),19,1,790,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),20,1,864,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),21,1,940,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),22,1,1020,10]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),23,0,920,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),24,0,992,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),25,0,1066,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),26,0,1144,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),27,0,1224,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),28,0,1306,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),29,0,1392,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),30,0,1480,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),31,0,1570,12]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("full"),32,0,1664,12]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	if (t===undefined) throw new Error("dict: format: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("compact");
	if (this.stk[this.ptr-2] instanceof Baren.psstring)
		this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
	this.ptr--;
	...
	this.stk[this.ptr++]=Baren.psarray([]);
	this.stk[this.ptr++]=Baren.psarray([]);
	this.stk[this.ptr++]=Baren.psarray([64,67]);
	this.stk[this.ptr++]=Baren.psarray([]);
	this.stk[this.ptr++]=Baren.psarray([256,301]);
	this.stk[this.ptr++]=Baren.psarray([]);
	this.stk[this.ptr++]=Baren.psarray([1024,1033]);
	this.stk[this.ptr++]=Baren.psarray([]);
	this.stk[this.ptr++]=Baren.psarray([4096,4201]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	for (t167 in t168) {
		if (t168 instanceof Baren.psstring || t168 instanceof Baren.psarray) {
