...
Baren.libs["royalmail"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("3300"),Baren.psstring("2211"),Baren.psstring("2301"),Baren.psstring("2310"),Baren.psstring("3201"),Baren.psstring("3210"),Baren.psstring("1122"),Baren.psstring("0033"),Baren.psstring("0123"),Baren.psstring("0132"),Baren.psstring("1023"),Baren.psstring("1032"),Baren.psstring("1302"),Baren.psstring("0213"),Baren.psstring("0303"),Baren.psstring("0312"),Baren.psstring("1203"),Baren.psstring("1212"),Baren.psstring("1320"),Baren.psstring("0231"),Baren.psstring("0321"),Baren.psstring("0330"),Baren.psstring("1221"),Baren.psstring("1230"),Baren.psstring("3102"),Baren.psstring("2013"),Baren.psstring("2103"),Baren.psstring("2112"),Baren.psstring("3003"),Baren.psstring("3012"),Baren.psstring("3120"),Baren.psstring("2031"),Baren.psstring("2121"),Baren.psstring("2130"),Baren.psstring("3021"),Baren.psstring("3030"),Baren.psstring("2"),Baren.psstring("3")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("ZUVWXY501234B6789AHCDEFGNIJKLMTOPQRS");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
