...
Baren.libs["qrcode"]=function() {
	...
	function $f12(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("full");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	function $f21(){
		this.stk[this.ptr++]=Baren.psstring("0000000000");
		this.stk[this.ptr++]=10;
		this.stk[this.ptr-1]=Baren.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof Baren.psstring||this.stk[this.ptr-1] instanceof Baren.psarray) {
	...
	function $f22(){
		this.stk[this.ptr++]=Baren.psstring("0000000");
		this.stk[this.ptr++]=7;
		this.stk[this.ptr-1]=Baren.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
	...
	function $f28(){
		this.stk[this.ptr++]=Baren.psstring("00000000000");
	...
	function $f29(){
		this.stk[this.ptr++]=Baren.psstring("000000");
		this.stk[this.ptr++]=6;
		this.stk[this.ptr-1]=Baren.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
	...
	function $f32(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]=Baren.psstring("00000000");
		this.stk[this.ptr++]=8;
		this.stk[this.ptr-1]=Baren.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
	...
	function $f37(){
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=Baren.psstring("0000000000000");
	...
	function $f45(){
		this.stk[this.ptr++]="encoding"; //ident
		this.stk[this.ptr++]=Baren.psstring("byte");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f46(){
		this.stk[this.ptr++]="encoding"; //ident
		this.stk[this.ptr++]=Baren.psstring("kanji");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f47(){
		this.stk[this.ptr++]="encoding"; //ident
		this.stk[this.ptr++]=Baren.psstring("alphanumeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f48(){
		this.stk[this.ptr++]="encoding"; //ident
	...
	function $f56(){
		...
		if (t===undefined) throw new Error("dict: format: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("micro");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
	...
	function $f68(){
		...
		this.stk[this.ptr++]=Baren.psarray([41,77,127,187,255,322,370,461,552,652,772,883,1022,1101,1250,1408,1548,1725,1903,2061,2232,2409,2620,2812,3057,3283,3517,3669,3909,4158,4417,4686,4965,5253,5529,5836,6153,6479,6743,7089]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([34,63,101,149,202,255,293,365,432,513,604,691,796,871,991,1082,1212,1346,1500,1600,1708,1872,2059,2188,2395,2544,2701,2857,3035,3289,3486,3693,3909,4134,4343,4588,4775,5039,5313,5596]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([27,48,77,111,144,178,207,259,312,364,427,489,580,621,703,775,876,948,1063,1159,1224,1358,1468,1588,1718,1804,1933,2085,2181,2358,2473,2670,2805,2949,3081,3244,3417,3599,3791,3993]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([17,34,58,82,106,139,154,202,235,288,331,374,427,468,530,602,674,746,813,919,969,1056,1108,1228,1286,1425,1501,1581,1677,1782,1897,2022,2157,2301,2361,2524,2625,2735,2927,3057]);
		var t = {};
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([25,47,77,114,154,195,224,279,335,395,468,535,619,667,758,854,938,1046,1153,1249,1352,1460,1588,1704,1853,1990,2132,2223,2369,2520,2677,2840,3009,3183,3351,3537,3729,3927,4087,4296]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([20,38,61,90,122,154,178,221,262,311,366,419,483,528,600,656,734,816,909,970,1035,1134,1248,1326,1451,1542,1637,1732,1839,1994,2113,2238,2369,2506,2632,2780,2894,3054,3220,3391]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([16,29,47,67,87,108,125,157,189,221,259,296,352,376,426,470,531,574,644,702,742,823,890,963,1041,1094,1172,1263,1322,1429,1499,1618,1700,1787,1867,1966,2071,2181,2298,2420]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([10,20,35,50,64,84,93,122,143,174,200,227,259,283,321,365,408,452,493,557,587,640,672,744,779,864,910,958,1016,1080,1150,1226,1307,1394,1431,1530,1591,1658,1774,1852]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
			if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
			t[this.stk[i-1]]=this.stk[i];
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([17,32,53,78,106,134,154,192,230,271,321,367,425,458,520,586,644,718,792,858,929,1003,1091,1171,1273,1367,1465,1528,1628,1732,1840,1952,2068,2188,2303,2431,2563,2699,2809,2953]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([14,26,42,62,84,106,122,152,180,213,251,287,331,362,412,450,504,560,624,666,711,779,857,911,997,1059,1125,1190,1264,1370,1452,1538,1628,1722,1809,1911,1989,2099,2213,2331]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([11,20,32,46,60,74,86,108,130,151,177,203,241,258,292,322,364,394,442,482,509,565,611,661,715,751,805,868,908,982,1030,1112,1168,1228,1283,1351,1423,1499,1579,1663]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([7,14,24,34,44,58,64,84,98,119,137,155,177,194,220,250,280,310,338,382,403,439,461,511,535,593,625,658,698,742,790,842,898,958,983,1051,1093,1139,1219,1273]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
			if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
			t[this.stk[i-1]]=this.stk[i];
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([10,20,32,48,65,82,95,118,141,167,198,226,262,282,320,361,397,442,488,528,572,618,672,721,784,842,902,940,1002,1066,1132,1201,1273,1347,1417,1496,1577,1661,1729,1817]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([8,16,26,38,52,65,75,93,111,131,155,177,204,223,254,277,310,345,384,410,438,480,528,561,614,652,692,732,778,843,894,947,1002,1060,1113,1176,1224,1292,1362,1435]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([7,12,20,28,37,45,53,66,80,93,109,125,149,159,180,198,224,243,272,297,314,348,376,407,440,462,496,534,559,604,634,684,719,756,790,832,876,923,972,1024]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([4,8,15,21,27,36,39,52,60,74,85,96,109,120,136,154,173,191,208,235,248,270,284,315,330,365,385,405,430,457,486,518,553,590,605,647,673,701,750,784]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
			if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
			t[this.stk[i-1]]=this.stk[i];
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([5,10,23,35]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,8,18,30]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,21]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,-1]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
			if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
			t[this.stk[i-1]]=this.stk[i];
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,6,14,21]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,5,11,18]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,13]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,-1]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,9,15]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,7,13]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,9]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,-1]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="L"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,6,9]);
		this.stk[this.ptr++]="M"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,4,8]);
		this.stk[this.ptr++]="Q"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,5]);
		this.stk[this.ptr++]="H"; //ident
		this.stk[this.ptr++]=Baren.psarray([-1,-1,-1,-1]);
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		...
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring("0001"),Baren.psstring("0010"),Baren.psstring("0100"),Baren.psstring("1000")]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="mids"; //ident
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="M1"; //ident
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring(""),-1,-1,-1]);
		this.stk[this.ptr++]="M2"; //ident
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring("0"),Baren.psstring("1"),-1,-1]);
		this.stk[this.ptr++]="M3"; //ident
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring("00"),Baren.psstring("01"),Baren.psstring("10"),Baren.psstring("11")]);
		this.stk[this.ptr++]="M4"; //ident
		this.stk[this.ptr++]=Baren.psarray([Baren.psstring("000"),Baren.psstring("001"),Baren.psstring("010"),Baren.psstring("011")]);
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		...
		this.stk[this.ptr++]=Baren.psarray([10,9,8,8]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="cc10to26"; //ident
		this.stk[this.ptr++]=Baren.psarray([12,11,16,10]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="cc27to40"; //ident
		this.stk[this.ptr++]=Baren.psarray([14,13,16,12]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="cclens"; //ident
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="M1"; //ident
		this.stk[this.ptr++]=Baren.psarray([3,-1,-1,-1]);
		this.stk[this.ptr++]="M2"; //ident
		this.stk[this.ptr++]=Baren.psarray([4,3,-1,-1]);
		this.stk[this.ptr++]="M3"; //ident
		this.stk[this.ptr++]=Baren.psarray([5,4,4,3]);
		this.stk[this.ptr++]="M4"; //ident
		this.stk[this.ptr++]=Baren.psarray([6,5,5,4]);
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=9;
		...
		this.stk[this.ptr++]=Baren.psstring("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		...
		if (t===undefined) throw new Error("dict: encoding: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("unset");
		if (this.stk[this.ptr-2] instanceof Baren.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]==this.stk[this.ptr-1];
		this.ptr--;
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]=Baren.psstring("0000000000000000");
		this.stk[this.ptr++]=0;
	...
	function $f101(){
		...
		for (t154 in t155) {
			if (t155 instanceof Baren.psstring || t155 instanceof Baren.psarray) {
	...
	function $f127(){
		...
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([0,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([1,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([2,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([3,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([4,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([5,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([7,8]);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,8]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,7]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,5]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,4]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,3]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,2]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,1]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,0]);
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t===undefined) throw new Error("dict: size: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f128(){
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([6,8]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		this.stk[this.ptr++]=Baren.psarray(t);
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([8,6]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
	...
	function $f130(){
		...
		for (t261 in t262) {
			if (t262 instanceof Baren.psstring || t262 instanceof Baren.psarray) {
	...
	function $f131(){
		...
		for (t264 in t265) {
			if (t265 instanceof Baren.psstring || t265 instanceof Baren.psarray) {
	...
	function $f133(){
		this.stk[this.ptr++]="versionmap"; //ident
		this.stk[this.ptr++]=Baren.psarray([]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f134(){
	}
	function $f135(){
		...
		for (t272 in t273) {
			if (t273 instanceof Baren.psstring || t273 instanceof Baren.psarray) {
	...
	function $f136(){
		...
		for (t275 in t276) {
			if (t276 instanceof Baren.psstring || t276 instanceof Baren.psarray) {
	...
	function $f146(){
		...
		this.stk[this.ptr++]=Baren.psarray([$f138,$f139,$f140,$f141,$f142,$f143,$f144,$f145]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f147(){
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f151(){
		this.stk[this.ptr++]="maskfuncs"; //ident
		this.stk[this.ptr++]=Baren.psarray([$f147,$f148,$f149,$f150]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f152(){
		this.stk[this.ptr++]=1;
	...
	function $f171(){
		...
		for (t312 in t313) {
			if (t313 instanceof Baren.psstring || t313 instanceof Baren.psarray) {
	...
	function $f173(){
		...
		for (t309 in t310) {
			if (t310 instanceof Baren.psstring || t310 instanceof Baren.psarray) {
	...
	function $f186(){
		...
		for (t334 in t335) {
			if (t335 instanceof Baren.psstring || t335 instanceof Baren.psarray) {
		...
		for (t339 in t340) {
			if (t340 instanceof Baren.psstring || t340 instanceof Baren.psarray) {
	...
	function $f188(){
		...
		for (t352 in t353) {
			if (t353 instanceof Baren.psstring || t353 instanceof Baren.psarray) {
	...
	function $f198(){
		...
		this.stk[this.ptr++]=Baren.psarray([21522,20773,24188,23371,17913,16590,20375,19104,30660,29427,32170,30877,26159,25368,27713,26998,5769,5054,7399,6608,1890,597,3340,2107,13663,12392,16177,14854,9396,8579,11994,11245]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="ecid"; //ident
		this.stk[this.ptr++]=Baren.psstring("MLHQ");
		var t=this.dstk.get("eclevel");
		if (t===undefined) throw new Error("dict: eclevel: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var h=this.stk[this.ptr-2];
	...
	function $f199(){
		this.stk[this.ptr++]="fmtvals"; //ident
		this.stk[this.ptr++]=Baren.psarray([17477,16754,20011,19228,21934,20633,24512,23287,26515,25252,28157,26826,30328,29519,31766,31009,1758,1001,3248,2439,5941,4610,7515,6252,9480,8255,12134,10833,13539,12756,16013,15290]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="symid"; //ident
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Baren.psarray([0]);
		this.stk[this.ptr++]=Baren.psarray([1,2]);
		this.stk[this.ptr++]=Baren.psarray([3,4]);
		this.stk[this.ptr++]=Baren.psarray([5,6,7]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
	...
	function $f201(){
		...
		for (t377 in t378) {
			if (t378 instanceof Baren.psstring || t378 instanceof Baren.psarray) {
	...
	function $f202(){
		...
		for (t380 in t381) {
			if (t381 instanceof Baren.psstring || t381 instanceof Baren.psarray) {
	...
	function $f204(){
		...
		for (t388 in t389) {
			if (t389 instanceof Baren.psstring || t389 instanceof Baren.psarray) {
	...
	function $f205(){
		...
		for (t391 in t392) {
			if (t392 instanceof Baren.psstring || t392 instanceof Baren.psarray) {
	...
	function $f206(){
		...
		this.stk[this.ptr++]=Baren.psarray([31892,34236,39577,42195,48118,51042,55367,58893,63784,68472,70749,76311,79154,84390,87683,92361,96236,102084,102881,110507,110734,117786,119615,126325,127568,133589,136957,141498,145311,150283,152622,158308,161089,167017]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="verval"; //ident
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("micro");
	this.stk[this.ptr++]=Baren.psstring("M1");
	this.stk[this.ptr++]=11;
	this.stk[this.ptr++]=98;
	this.stk[this.ptr++]=99;
	this.stk[this.ptr++]=36;
	this.stk[this.ptr++]=Baren.psarray([2,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([1,0,-1,-1,-1,-1,-1,-1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("micro");
	this.stk[this.ptr++]=Baren.psstring("M2");
	this.stk[this.ptr++]=13;
	this.stk[this.ptr++]=98;
	this.stk[this.ptr++]=99;
	this.stk[this.ptr++]=80;
	this.stk[this.ptr++]=Baren.psarray([5,6,99,99]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,-1,-1,-1,-1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("micro");
	this.stk[this.ptr++]=Baren.psstring("M3");
	this.stk[this.ptr++]=15;
	this.stk[this.ptr++]=98;
	this.stk[this.ptr++]=99;
	this.stk[this.ptr++]=132;
	this.stk[this.ptr++]=Baren.psarray([6,8,99,99]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,-1,-1,-1,-1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("micro");
	this.stk[this.ptr++]=Baren.psstring("M4");
	this.stk[this.ptr++]=17;
	this.stk[this.ptr++]=98;
	this.stk[this.ptr++]=99;
	this.stk[this.ptr++]=192;
	this.stk[this.ptr++]=Baren.psarray([8,10,14,99]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,1,0,-1,-1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([7,10,13,17]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,1,0,1,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([10,16,22,28]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,1,0,1,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	...
	this.stk[this.ptr++]=Baren.psarray([15,26,36,44]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,2,0,2,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([20,36,52,64]);
	this.stk[this.ptr++]=Baren.psarray([1,0,2,0,2,0,4,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([26,48,72,88]);
	this.stk[this.ptr++]=Baren.psarray([1,0,2,0,2,2,2,2]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([36,64,96,112]);
	this.stk[this.ptr++]=Baren.psarray([2,0,4,0,4,0,4,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([40,72,108,130]);
	this.stk[this.ptr++]=Baren.psarray([2,0,4,0,2,4,4,1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([48,88,132,156]);
	this.stk[this.ptr++]=Baren.psarray([2,0,2,2,4,2,4,2]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([60,110,160,192]);
	this.stk[this.ptr++]=Baren.psarray([2,0,3,2,4,4,4,4]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("10");
	this.stk[this.ptr++]=57;
	this.stk[this.ptr++]=28;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=2768;
	this.stk[this.ptr++]=Baren.psarray([72,130,192,224]);
	this.stk[this.ptr++]=Baren.psarray([2,2,4,1,6,2,6,2]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("11");
	this.stk[this.ptr++]=61;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=3232;
	this.stk[this.ptr++]=Baren.psarray([80,150,224,264]);
	this.stk[this.ptr++]=Baren.psarray([4,0,1,4,4,4,3,8]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("12");
	this.stk[this.ptr++]=65;
	this.stk[this.ptr++]=32;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=3728;
	this.stk[this.ptr++]=Baren.psarray([96,176,260,308]);
	this.stk[this.ptr++]=Baren.psarray([2,2,6,2,4,6,7,4]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("13");
	this.stk[this.ptr++]=69;
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=62;
	this.stk[this.ptr++]=4256;
	this.stk[this.ptr++]=Baren.psarray([104,198,288,352]);
	this.stk[this.ptr++]=Baren.psarray([4,0,8,1,8,4,12,4]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("14");
	this.stk[this.ptr++]=73;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=46;
	this.stk[this.ptr++]=4651;
	this.stk[this.ptr++]=Baren.psarray([120,216,320,384]);
	this.stk[this.ptr++]=Baren.psarray([3,1,4,5,11,5,11,5]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("15");
	this.stk[this.ptr++]=77;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=48;
	this.stk[this.ptr++]=5243;
	this.stk[this.ptr++]=Baren.psarray([132,240,360,432]);
	this.stk[this.ptr++]=Baren.psarray([5,1,5,5,5,7,11,7]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("16");
	this.stk[this.ptr++]=81;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=5867;
	this.stk[this.ptr++]=Baren.psarray([144,280,408,480]);
	this.stk[this.ptr++]=Baren.psarray([5,1,7,3,15,2,3,13]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("17");
	this.stk[this.ptr++]=85;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=6523;
	this.stk[this.ptr++]=Baren.psarray([168,308,448,532]);
	this.stk[this.ptr++]=Baren.psarray([1,5,10,1,1,15,2,17]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("18");
	this.stk[this.ptr++]=89;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=56;
	this.stk[this.ptr++]=7211;
	this.stk[this.ptr++]=Baren.psarray([180,338,504,588]);
	this.stk[this.ptr++]=Baren.psarray([5,1,9,4,17,1,2,19]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("19");
	this.stk[this.ptr++]=93;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=7931;
	this.stk[this.ptr++]=Baren.psarray([196,364,546,650]);
	this.stk[this.ptr++]=Baren.psarray([3,4,3,11,17,4,9,16]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("20");
	this.stk[this.ptr++]=97;
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=62;
	this.stk[this.ptr++]=8683;
	this.stk[this.ptr++]=Baren.psarray([224,416,600,700]);
	this.stk[this.ptr++]=Baren.psarray([3,5,3,13,15,5,15,10]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("21");
	this.stk[this.ptr++]=101;
	this.stk[this.ptr++]=28;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=9252;
	this.stk[this.ptr++]=Baren.psarray([224,442,644,750]);
	this.stk[this.ptr++]=Baren.psarray([4,4,17,0,17,6,19,6]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("22");
	this.stk[this.ptr++]=105;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=10068;
	this.stk[this.ptr++]=Baren.psarray([252,476,690,816]);
	this.stk[this.ptr++]=Baren.psarray([2,7,17,0,7,16,34,0]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("23");
	this.stk[this.ptr++]=109;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=10916;
	this.stk[this.ptr++]=Baren.psarray([270,504,750,900]);
	this.stk[this.ptr++]=Baren.psarray([4,5,4,14,11,14,16,14]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("24");
	this.stk[this.ptr++]=113;
	this.stk[this.ptr++]=28;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=11796;
	this.stk[this.ptr++]=Baren.psarray([300,560,810,960]);
	this.stk[this.ptr++]=Baren.psarray([6,4,6,14,11,16,30,2]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("25");
	this.stk[this.ptr++]=117;
	this.stk[this.ptr++]=32;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=12708;
	this.stk[this.ptr++]=Baren.psarray([312,588,870,1050]);
	this.stk[this.ptr++]=Baren.psarray([8,4,8,13,7,22,22,13]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("26");
	this.stk[this.ptr++]=121;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=13652;
	this.stk[this.ptr++]=Baren.psarray([336,644,952,1110]);
	this.stk[this.ptr++]=Baren.psarray([10,2,19,4,28,6,33,4]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("27");
	this.stk[this.ptr++]=125;
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=62;
	this.stk[this.ptr++]=14628;
	this.stk[this.ptr++]=Baren.psarray([360,700,1020,1200]);
	this.stk[this.ptr++]=Baren.psarray([8,4,22,3,8,26,12,28]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("28");
	this.stk[this.ptr++]=129;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=15371;
	this.stk[this.ptr++]=Baren.psarray([390,728,1050,1260]);
	this.stk[this.ptr++]=Baren.psarray([3,10,3,23,4,31,11,31]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("29");
	this.stk[this.ptr++]=133;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=16411;
	this.stk[this.ptr++]=Baren.psarray([420,784,1140,1350]);
	this.stk[this.ptr++]=Baren.psarray([7,7,21,7,1,37,19,26]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("30");
	this.stk[this.ptr++]=137;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=52;
	this.stk[this.ptr++]=17483;
	this.stk[this.ptr++]=Baren.psarray([450,812,1200,1440]);
	this.stk[this.ptr++]=Baren.psarray([5,10,19,10,15,25,23,25]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("31");
	this.stk[this.ptr++]=141;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=56;
	this.stk[this.ptr++]=18587;
	this.stk[this.ptr++]=Baren.psarray([480,868,1290,1530]);
	this.stk[this.ptr++]=Baren.psarray([13,3,2,29,42,1,23,28]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("32");
	this.stk[this.ptr++]=145;
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=60;
	this.stk[this.ptr++]=19723;
	this.stk[this.ptr++]=Baren.psarray([510,924,1350,1620]);
	this.stk[this.ptr++]=Baren.psarray([17,0,10,23,10,35,19,35]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("33");
	this.stk[this.ptr++]=149;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=20891;
	this.stk[this.ptr++]=Baren.psarray([540,980,1440,1710]);
	this.stk[this.ptr++]=Baren.psarray([17,1,14,21,29,19,11,46]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("34");
	this.stk[this.ptr++]=153;
	this.stk[this.ptr++]=34;
	this.stk[this.ptr++]=62;
	this.stk[this.ptr++]=22091;
	this.stk[this.ptr++]=Baren.psarray([570,1036,1530,1800]);
	this.stk[this.ptr++]=Baren.psarray([13,6,14,23,44,7,59,1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("35");
	this.stk[this.ptr++]=157;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=23008;
	this.stk[this.ptr++]=Baren.psarray([570,1064,1590,1890]);
	this.stk[this.ptr++]=Baren.psarray([12,7,12,26,39,14,22,41]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("36");
	this.stk[this.ptr++]=161;
	this.stk[this.ptr++]=24;
	this.stk[this.ptr++]=50;
	this.stk[this.ptr++]=24272;
	this.stk[this.ptr++]=Baren.psarray([600,1120,1680,1980]);
	this.stk[this.ptr++]=Baren.psarray([6,14,6,34,46,10,2,64]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("37");
	this.stk[this.ptr++]=165;
	this.stk[this.ptr++]=28;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=25568;
	this.stk[this.ptr++]=Baren.psarray([630,1204,1770,2100]);
	this.stk[this.ptr++]=Baren.psarray([17,4,29,14,49,10,24,46]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("38");
	this.stk[this.ptr++]=169;
	this.stk[this.ptr++]=32;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=26896;
	this.stk[this.ptr++]=Baren.psarray([660,1260,1860,2220]);
	this.stk[this.ptr++]=Baren.psarray([4,18,13,32,48,14,42,32]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("39");
	this.stk[this.ptr++]=173;
	this.stk[this.ptr++]=26;
	this.stk[this.ptr++]=54;
	this.stk[this.ptr++]=28256;
	this.stk[this.ptr++]=Baren.psarray([720,1316,1950,2310]);
	this.stk[this.ptr++]=Baren.psarray([20,4,40,7,43,22,10,67]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psstring("full");
	this.stk[this.ptr++]=Baren.psstring("40");
	this.stk[this.ptr++]=177;
	this.stk[this.ptr++]=30;
	this.stk[this.ptr++]=58;
	this.stk[this.ptr++]=29648;
	this.stk[this.ptr++]=Baren.psarray([750,1372,2040,2430]);
	this.stk[this.ptr++]=Baren.psarray([19,6,18,31,34,34,20,61]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psstring("LMQH");
	var t=this.dstk.get("eclevel");
	if (t===undefined) throw new Error("dict: eclevel: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var h=this.stk[this.ptr-2];
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]="M1"; //ident
	this.stk[this.ptr++]=Baren.psstring("000");
	this.stk[this.ptr++]="M2"; //ident
	this.stk[this.ptr++]=Baren.psstring("00000");
	this.stk[this.ptr++]="M3"; //ident
	this.stk[this.ptr++]=Baren.psstring("0000000");
	this.stk[this.ptr++]="M4"; //ident
	this.stk[this.ptr++]=Baren.psstring("000000000");
	var t = {};
	for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
		t[this.stk[i-1]]=this.stk[i];
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("11101100"),Baren.psstring("00010001")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="padnum"; //ident
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([1,1,1,1,1,1,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,0,0,0,0,0,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,1,1,0,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,1,1,0,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,1,1,0,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,0,0,0,0,0,1,0]);
	this.stk[this.ptr++]=Baren.psarray([1,1,1,1,1,1,1,0]);
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([1,1,1,1,1]);
	this.stk[this.ptr++]=Baren.psarray([1,0,0,0,1]);
	this.stk[this.ptr++]=Baren.psarray([1,0,1,0,1]);
	this.stk[this.ptr++]=Baren.psarray([1,0,0,0,1]);
	this.stk[this.ptr++]=Baren.psarray([1,1,1,1,1]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	...
	for (t267 in t268) {
		if (t268 instanceof Baren.psstring || t268 instanceof Baren.psarray) {
	...
	for (t278 in t279) {
		if (t279 instanceof Baren.psstring || t279 instanceof Baren.psarray) {
