...
Baren.libs["codeone"]=function() {
	...
	function $f59(){
		...
		for (t108 in t109) {
			if (t109 instanceof Baren.psstring || t109 instanceof Baren.psarray) {
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="encoding"; //ident
	this.stk[this.ptr++]=Baren.psstring("ascii");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="raw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("A"),16,18,16,10,10,1,4,99,6]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("B"),22,22,20,19,16,1,4,99,8]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("C"),28,32,28,44,26,1,4,22,11]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("D"),40,42,36,91,44,1,4,16,16]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("E"),52,54,48,182,70,1,4,22,22]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("F"),70,76,68,370,140,2,4,22,31]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("G"),104,98,88,732,280,4,6,21,47]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("H"),148,134,120,1480,560,8,6,20,69]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("S-10"),8,11,10,4,4,1,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("S-20"),8,21,20,8,8,1,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("S-30"),8,31,30,12,12,1,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("T-16"),16,17,16,10,10,1,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("T-32"),16,33,32,24,16,1,99,99,99]);
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("T-48"),16,49,48,38,22,1,99,99,99]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Baren.psarray([$f65,$f67,$f69,$f71,$f74,$f77,$f79,$f81]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="cpat"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]="A"; //ident
	this.stk[this.ptr++]=Baren.psstring("121343");
	this.stk[this.ptr++]="B"; //ident
	this.stk[this.ptr++]=Baren.psstring("12134343");
	this.stk[this.ptr++]="C"; //ident
	this.stk[this.ptr++]=Baren.psstring("12121343");
	this.stk[this.ptr++]="D"; //ident
	this.stk[this.ptr++]=Baren.psstring("1213434343");
	this.stk[this.ptr++]="E"; //ident
	this.stk[this.ptr++]=Baren.psstring("1212134343");
	this.stk[this.ptr++]="F"; //ident
	this.stk[this.ptr++]=Baren.psstring("1212121343");
	this.stk[this.ptr++]="G"; //ident
	this.stk[this.ptr++]=Baren.psstring("121213434343");
	this.stk[this.ptr++]="H"; //ident
	this.stk[this.ptr++]=Baren.psstring("121212134343");
	this.stk[this.ptr++]="S"; //ident
	this.stk[this.ptr++]=Baren.psstring("56661278");
	this.stk[this.ptr++]="T"; //ident
	this.stk[this.ptr++]=Baren.psstring("5666666666127878");
	var t = {};
	...
	this.stk[this.ptr++]="A"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([12,5]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="B"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([16,7]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="C"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([26,12]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="E"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([26,23]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="F"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([26,32]);
	this.stk[this.ptr++]=Baren.psarray([70,32]);
	this.stk[this.ptr++]=Baren.psarray([26,34]);
	this.stk[this.ptr++]=Baren.psarray([70,34]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="G"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([27,48]);
	this.stk[this.ptr++]=Baren.psarray([69,48]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]="H"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([26,70]);
	this.stk[this.ptr++]=Baren.psarray([66,70]);
	this.stk[this.ptr++]=Baren.psarray([106,70]);
	this.stk[this.ptr++]=Baren.psarray([26,72]);
	this.stk[this.ptr++]=Baren.psarray([66,72]);
	this.stk[this.ptr++]=Baren.psarray([106,72]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([10,4]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([15,4]);
	this.stk[this.ptr++]=Baren.psarray([15,6]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([8,10]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([16,10]);
	this.stk[this.ptr++]=Baren.psarray([16,12]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
	...
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=Baren.psarray([24,10]);
	this.stk[this.ptr++]=Baren.psarray([24,12]);
	this.stk[this.ptr++]=Baren.psarray([24,14]);
	for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
	if (i < 0) throw "array: underflow";
	var t = this.stk.splice(i+1, this.ptr-1-i);
	this.ptr = i;
