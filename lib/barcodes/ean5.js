...
Baren.libs["ean5"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("3211"),Baren.psstring("2221"),Baren.psstring("2122"),Baren.psstring("1411"),Baren.psstring("1132"),Baren.psstring("1231"),Baren.psstring("1114"),Baren.psstring("1312"),Baren.psstring("1213"),Baren.psstring("3112"),Baren.psstring("112"),Baren.psstring("11")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("0123456789");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="mirrormaps"; //ident
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("11000"),Baren.psstring("10100"),Baren.psstring("10010"),Baren.psstring("10001"),Baren.psstring("01100"),Baren.psstring("00110"),Baren.psstring("00011"),Baren.psstring("01010"),Baren.psstring("01001"),Baren.psstring("00101")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="checksum"; //ident
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	for (t30 in t31) {
		if (t31 instanceof Baren.psstring || t31 instanceof Baren.psarray) {
