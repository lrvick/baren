...
//if (!Baren.libs["code93"]) Baren.load("bwipp/code93.js");
Baren.libs["code93ext"]=function() {
	this.dict["renlinear"]=Baren.libs["renlinear"];
	this.dict["code93"]=Baren.libs["code93"];
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	function $f15(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Baren.psstring("txt");
		if (this.stk[this.ptr-2] instanceof Baren.psstring || this.stk[this.ptr-2] instanceof Baren.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
		this.ptr--;
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("^SFT%U"),Baren.psstring("^SFT$A"),Baren.psstring("^SFT$B"),Baren.psstring("^SFT$C"),Baren.psstring("^SFT$D"),Baren.psstring("^SFT$E"),Baren.psstring("^SFT$F"),Baren.psstring("^SFT$G"),Baren.psstring("^SFT$H"),Baren.psstring("^SFT$I"),Baren.psstring("^SFT$J"),Baren.psstring("^SFT$K"),Baren.psstring("^SFT$L"),Baren.psstring("^SFT$M"),Baren.psstring("^SFT$N"),Baren.psstring("^SFT$O"),Baren.psstring("^SFT$P"),Baren.psstring("^SFT$Q"),Baren.psstring("^SFT$R"),Baren.psstring("^SFT$S"),Baren.psstring("^SFT$T"),Baren.psstring("^SFT$U"),Baren.psstring("^SFT$V"),Baren.psstring("^SFT$W"),Baren.psstring("^SFT$X"),Baren.psstring("^SFT$Y"),Baren.psstring("^SFT$Z"),Baren.psstring("^SFT%A"),Baren.psstring("^SFT%B"),Baren.psstring("^SFT%C"),Baren.psstring("^SFT%D"),Baren.psstring("^SFT%E"),Baren.psstring(" "),Baren.psstring("^SFT/A"),Baren.psstring("^SFT/B"),Baren.psstring("^SFT/C"),Baren.psstring("^SFT/D"),Baren.psstring("^SFT/E"),Baren.psstring("^SFT/F"),Baren.psstring("^SFT/G"),Baren.psstring("^SFT/H"),Baren.psstring("^SFT/I"),Baren.psstring("^SFT/J"),Baren.psstring("^SFT/K"),Baren.psstring("^SFT/L"),Baren.psstring("-"),Baren.psstring("."),Baren.psstring("^SFT/O"),Baren.psstring("0"),Baren.psstring("1"),Baren.psstring("2"),Baren.psstring("3"),Baren.psstring("4"),Baren.psstring("5"),Baren.psstring("6"),Baren.psstring("7"),Baren.psstring("8"),Baren.psstring("9"),Baren.psstring("^SFT/Z"),Baren.psstring("^SFT%F"),Baren.psstring("^SFT%G"),Baren.psstring("^SFT%H"),Baren.psstring("^SFT%I"),Baren.psstring("^SFT%J"),Baren.psstring("^SFT%V"),Baren.psstring("A"),Baren.psstring("B"),Baren.psstring("C"),Baren.psstring("D"),Baren.psstring("E"),Baren.psstring("F"),Baren.psstring("G"),Baren.psstring("H"),Baren.psstring("I"),Baren.psstring("J"),Baren.psstring("K"),Baren.psstring("L"),Baren.psstring("M"),Baren.psstring("N"),Baren.psstring("O"),Baren.psstring("P"),Baren.psstring("Q"),Baren.psstring("R"),Baren.psstring("S"),Baren.psstring("T"),Baren.psstring("U"),Baren.psstring("V"),Baren.psstring("W"),Baren.psstring("X"),Baren.psstring("Y"),Baren.psstring("Z"),Baren.psstring("^SFT%K"),Baren.psstring("^SFT%L"),Baren.psstring("^SFT%M"),Baren.psstring("^SFT%N"),Baren.psstring("^SFT%O"),Baren.psstring("^SFT%W"),Baren.psstring("^SFT+A"),Baren.psstring("^SFT+B"),Baren.psstring("^SFT+C"),Baren.psstring("^SFT+D"),Baren.psstring("^SFT+E"),Baren.psstring("^SFT+F"),Baren.psstring("^SFT+G"),Baren.psstring("^SFT+H"),Baren.psstring("^SFT+I"),Baren.psstring("^SFT+J"),Baren.psstring("^SFT+K"),Baren.psstring("^SFT+L"),Baren.psstring("^SFT+M"),Baren.psstring("^SFT+N"),Baren.psstring("^SFT+O"),Baren.psstring("^SFT+P"),Baren.psstring("^SFT+Q"),Baren.psstring("^SFT+R"),Baren.psstring("^SFT+S"),Baren.psstring("^SFT+T"),Baren.psstring("^SFT+U"),Baren.psstring("^SFT+V"),Baren.psstring("^SFT+W"),Baren.psstring("^SFT+X"),Baren.psstring("^SFT+Y"),Baren.psstring("^SFT+Z"),Baren.psstring("^SFT%P"),Baren.psstring("^SFT%Q"),Baren.psstring("^SFT%R"),Baren.psstring("^SFT%S"),Baren.psstring("^SFT%T")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("parsefnc");
	this.stk[this.ptr++]=true;
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
		this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
	else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	...
	if (t===undefined) throw new Error("dict: args: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("opt");
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
