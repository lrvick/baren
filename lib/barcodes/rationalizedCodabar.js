...
Baren.libs["rationalizedCodabar"]=function() {
	...
	this.stk[this.ptr++]=Baren.psarray([Baren.psstring("11111331"),Baren.psstring("11113311"),Baren.psstring("11131131"),Baren.psstring("33111111"),Baren.psstring("11311311"),Baren.psstring("31111311"),Baren.psstring("13111131"),Baren.psstring("13113111"),Baren.psstring("13311111"),Baren.psstring("31131111"),Baren.psstring("11133111"),Baren.psstring("11331111"),Baren.psstring("31113131"),Baren.psstring("31311131"),Baren.psstring("31313111"),Baren.psstring("11313131"),Baren.psstring("11331311"),Baren.psstring("13131131"),Baren.psstring("11131331"),Baren.psstring("11133311")]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="barchars"; //ident
	this.stk[this.ptr++]=Baren.psstring("0123456789-$:/.+ABCD");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
