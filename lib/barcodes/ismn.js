...
//if (!Baren.libs["ean13"]) Baren.load("bwipp/ean13.js");
Baren.libs["ismn"]=function() {
	this.dict["renlinear"]=Baren.libs["renlinear"];
	this.dict["ean13"]=Baren.libs["ean13"];
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	function $f10(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=Baren.psstring("979-0-");
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=Baren.psstring("ISMN ");
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	var t=this.dstk.get("pad");
	if (t===undefined) throw new Error("dict: pad: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=Baren.psstring("addongap");
	var t=this.dstk.get("addongap");
	if (t===undefined) throw new Error("dict: addongap: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (this.stk[this.ptr-3] instanceof Baren.psstring || this.stk[this.ptr-3] instanceof Baren.psarray)
