...
//if (!Baren.libs["databarlimited"]) Baren.load("bwipp/databarlimited.js");
...
Baren.libs["databarlimitedcomposite"]=function() {
	this.dict["databarlimited"]=Baren.libs["databarlimited"];
	...
	this.stk[this.ptr++]=Baren.psstring("databarlimited");
	...
	for (t15 in t16) {
		if (t16 instanceof Baren.psstring || t16 instanceof Baren.psarray) {
